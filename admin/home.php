                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <a href="home.php" class="btn btn-default active">All files</a>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <?php
                                            ...
                                            if ($level_active!='admin') {
                                                $res = $conn->query("SELECT * FROM tbl_upload inner join tbl_user on tbl_upload.nama = tbl_user.id_user where level='user'");
                                            } else {
