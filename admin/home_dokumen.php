                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <a href="home_musik.php" class="btn btn-default">Musik</a>
                            <a href="home_video.php" class="btn btn-default">Video</a>
                            <a href="home_gambar.php" class="btn btn-default">Gambar</a>
                            <a href="home_dokumen.php" class="btn btn-default active">Dokumen</a>
                            <br/>
                            <br/>
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <?php
                                            ...
                                            if ($level_active!='admin') {
                                                $res = $conn->query("SELECT * FROM tbl_upload inner join tbl_user on tbl_upload.nama = tbl_user.id_user where level='user' and kategori='Dokumen'");
                                            } else {
                                                $res = $conn->query("SELECT * FROM tbl_upload inner join tbl_user on tbl_upload.nama = tbl_user.id_user where kategori='Dokumen'");
                                            }
