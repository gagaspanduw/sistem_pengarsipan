...
{echo "<script>alert('Nama file tidak boleh sama'); window.location='upload_admin.php'</script>";
        ...
        if($kategori == 'Gambar'){
            ...
            echo "<script>alert('Berhasil Menyimpan data'); window.location='upload.php'</script>";
            }
            else{
                echo "<script>alert('Maaf, File tidak sesuai kategori. ekstensi untuk gambar yang diperbolehkan (.jpg, .jpeg, .png)'); window.location='upload.php'</script>";
            }
        }
        elseif ($kategori == 'Video'){
            ...
            echo "<script>alert('Berhasil Menyimpan data'); window.location='upload.php'</script>";
                ...
                echo "<script>alert('Maaf, File tidak sesuai kategori. ekstensi untuk video yang diperbolehkan (.mp4, .3gp, .mkv)'); window.location='upload.php'</script>";
            }
        }
        elseif ($kategori == 'Dokumen'){
            ...
            echo "<script>alert('Berhasil Menyimpan data'); window.location='upload.php'</script>";
                ...
                echo "<script>alert('Maaf, File tidak sesuai kategori. ekstensi untuk Dokumen yang diperbolehkan (.doc, .docx, .pdf, .xls, .xlsx, .ppt, .pptx, .accdb, .rar)'); window.location='upload.php'</script>";
            }
        }
        elseif ($kategori == 'Musik'){
            ...
            echo "<script>alert('Berhasil Menyimpan data'); window.location='upload.php'</script>";
                ...
                echo "<script>alert('Maaf, File tidak sesuai kategori. ekstensi untuk musik yang diperbolehkan (.mp3)'); window.location='upload.php'</script>";
            }
        }
        else{
            echo "<script>alert('Anda belum memilih kategori'); window.location='upload.php'</script>";
        }
}
}
?>             
